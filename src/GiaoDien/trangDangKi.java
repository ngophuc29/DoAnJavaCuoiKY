...
public class trangDangKi extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					trangDangKi frame = new trangDangKi();
	...
	public trangDangKi() {
		...
		lblNewLabel_2.setIcon(new ImageIcon(trangDangKi.class.getResource("/img/iconregester.png")));
