...
public class trangDangKiUI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					trangDangKiUI frame = new trangDangKiUI();
	...
	public trangDangKiUI() {
		...
		lblNewLabel.setBounds(56, 28, 183, 42);
		contentPane.add(lblNewLabel);
		
		JLabel lbluser = new JLabel("Tài Khoản :");
		lbluser.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lbluser.setBounds(87, 138, 94, 29);
		contentPane.add(lbluser);
		
		textField = new JTextField();
		textField.setBounds(202, 128, 274, 39);
		contentPane.add(textField);
		textField.setColumns(10);
		
		JLabel lblNewLabel_1 = new JLabel("Mật Khẩu :");
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblNewLabel_1.setBounds(98, 178, 94, 39);
		contentPane.add(lblNewLabel_1);
		
		textField_1 = new JTextField();
		textField_1.setColumns(10);
		textField_1.setBounds(202, 180, 274, 39);
		contentPane.add(textField_1);
		
		JLabel lblNewLabel_1_1 = new JLabel("Nhập Lại Mật Khẩu :");
		lblNewLabel_1_1.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblNewLabel_1_1.setBounds(38, 228, 143, 39);
		...
		textField_3.setBounds(202, 78, 274, 39);
		contentPane.add(textField_3);
		
		JLabel lblNewLabel_2 = new JLabel("");
		lblNewLabel_2.setIcon(new ImageIcon(trangDangKiUI.class.getResource("/img/iconregester.png")));
